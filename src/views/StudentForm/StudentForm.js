        ...
        <Row>
          <Col xs="12" md="6">
            <Card>
              ...
              <CardBody>
                <Form action="" method="post" encType="multipart/form-data" className="form-horizontal">
                  ...
                  <FormGroup row>
                    ...
                    <Col xs="12" md="9">
                      <Input onChange={this.handleOnChange.bind(this, stdcolumntype.no)} type="text" id="text-input" name="text-input-no" placeholder="" />
                  ...
                  <FormGroup row>
                    ...
                    <Col xs="12" md="9">
                      <Input onChange={this.handleOnChange.bind(this, stdcolumntype.teacher)}  type="text" id="text-input" name="text-input-teacher" placeholder="" />
                      <FormText color="muted"></FormText>
                    </Col>
                  </FormGroup>
                  <FormGroup row>
              ...
              <CardFooter>
                <Button type="submit" size="sm" color="primary"><i className="fa fa-dot-circle-o"></i> Kaydet</Button>
